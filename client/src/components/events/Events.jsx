export default function Events(){
  ...
  <div className="container_12 top-4">
    <div className="grid_4">
      ...
      <p><a href="#" className="link">7.05.2012</a></p>
      ...
      <p className="p3">Sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed <br/>
        diam voluptua.</p>
      <p><a href="#" className="link">2.05.2012</a></p>
      ...
      <p className="p3">Duo dolores et ea rebum stet clita kasd gubergren, no sea takimata sanctus est <br/>
        ...
        dolor.</p>
      <p><a href="#" className="link">29.04.2012</a></p>
      ...
      <p><a href="#" className="link">12.04.2012</a></p>
      ...
      <div className="left-1">
        ...
        <div className="lists">
          <ul className="list-2">
            ...
            <li><a href="#">Nobis eleifend option congue nihil</a></li>
            <li><a href="#">Imperdiet doming id quod mazim placerat</a></li>
            <li><a href="#">Facer possim assum. Lorem ipsum dolor</a></li>
            <li><a href="#">Sit amet, consectetuer adipiscing</a></li>
          </ul>
          <ul className="list-2 last">
            <li><a href="#">Elit sed diam nonummy nibh euismod</a></li>
            <li><a href="#">Tincidunt ut laoreet dolore magna aliquam</a></li>
            <li><a href="#">Ut wisi enim ad minim veniam quis</a></li>
            <li><a href="#">Nostrud exerci tation ullamcorper suscipit</a></li>
            <li><a href="#">Lobortis nisl ut aliquip ex ea</a></li>
          </ul>
        </div>
        <h2 className="p5 top-6">Upcoming Events</h2>
        <div className="wrap p2"> <img src="images/page4-img2.jpg" alt="" className="img-indent-2"/>
          <div className="extra-wrap">
            <p><a href="#" className="link">13.05.2012</a></p>
        ...
        <div className="wrap"> <img src="images/page4-img3.jpg" alt="" className="img-indent-2"/>
          <div className="extra-wrap">
            <p><a href="#" className="link">17.05.2012</a></p>
