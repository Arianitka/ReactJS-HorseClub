...
export default function Events(){
  ...
  <div className="container_12 top-4">
    <div className="grid_4">
      ...
      <p><Link href="#" className="link">7.05.2012</Link></p>
      ...
      <p className="p3">Sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed <br/>
        diam voluptua.</p>
      <p><Link href="#" className="link">2.05.2012</Link></p>
      ...
      <p className="p3">Duo dolores et ea rebum stet clita kasd gubergren, no sea takimata sanctus est <br/>
        ...
        dolor.</p>
      <p><Link href="#" className="link">29.04.2012</Link></p>
      ...
      <p><Link href="#" className="link">12.04.2012</Link></p>
    ...
    <div className="grid_8">
      <div className="left-1">
        ...
        <div className="lists">
          <ul className="list-2">
            <li><Link href="#">Nam liber tempor cum soluta</Link></li>
            <li><Link href="#">Nobis eleifend option congue nihil</Link></li>
            <li><Link href="#">Imperdiet doming id quod mazim placerat</Link></li>
            <li><Link href="#">Facer possim assum. Lorem ipsum dolor</Link></li>
            <li><Link href="#">Sit amet, consectetuer adipiscing</Link></li>
          </ul>
          <ul className="list-2 last">
            <li><Link href="#">Elit sed diam nonummy nibh euismod</Link></li>
            <li><Link href="#">Tincidunt ut laoreet dolore magna aliquam</Link></li>
            <li><Link href="#">Ut wisi enim ad minim veniam quis</Link></li>
            <li><Link href="#">Nostrud exerci tation ullamcorper suscipit</Link></li>
            <li><Link href="#">Lobortis nisl ut aliquip ex ea</Link></li>
          </ul>
        </div>
        <h2 className="p5 top-6">Upcoming Events</h2>
        <div className="wrap p2"> <img src="images/page4-img2.jpg" alt="" className="img-indent-2"/>
          <div className="extra-wrap">
            <p><Link href="#" className="link">13.05.2012</Link></p>
        ...
        <div className="wrap"> <img src="images/page4-img3.jpg" alt="" className="img-indent-2"/>
          <div className="extra-wrap">
            <p><Link href="#" className="link">17.05.2012</Link></p>
