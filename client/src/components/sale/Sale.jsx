...
export default function Sale(){
  ...
  <div className="container_12 top-4">
    <div className="grid_4">
      ...
      <ul className="list-2">
        {/* <li><Link to="#">Magna aliquyam erat sed diam</Link></li>
        <li><Link to="#">At vero eos et accusam</Link></li>
        <li><Link to="#">Stet clita kasd gubergren sea takimata</Link></li>
        <li><Link to="#">Lorem ipsum dolor sit amet</Link></li>
        <li><Link to="#">Consetetur sadipscing elitr sed</Link></li>
        <li><Link to="#">Diam nonumy eirmod</Link></li>
        <li><Link to="#">Tempor invidunt ut labore et dolore</Link></li>
        <li><Link to="#">Magna aliquyam erat, sed diam</Link></li>
        <li><Link to="#">At vero eos et accusam</Link></li> */}
      </ul>
    </div>
