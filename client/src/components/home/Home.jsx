          ...
          <div className="grid_4">
            <div className="left-1">
              ...
              <div className="wrap">
                ...
                <p className="extra-wrap border-bot-1"><span className="clr-1">Lorem ipsum</span>
                  Horse Club is one of free website templates created by Template Monster team. </p>
              </div>
              <div className="wrap">
                <div className="number">2</div>
                <p className="extra-wrap border-bot-1"><span className="clr-1">Aliquyam erat</span>
                  This website template is optimized for 1280X1024 screen resolution. It is also XHTML & CSS valid.</p>
              </div>
              <div className="wrap">
                <div className="number">3</div>
                <p className="extra-wrap"><span className="clr-1">No sea takimata</span>
            ...
            <div className="left-2">
              ...
              <div className="wrap border-bot-1"> <img src="./src/images/page1-img5.jpg" alt="" className="img-indent"/>
                <p className="extra-wrap"/><span className="clr-1">At vero eos et accusam</span>
                  <a href="#" className="link">May 3, 2024</a>
